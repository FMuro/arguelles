...
\usetheme{Arguello}
\bibliography{demo} % this is the biblatex file, this line should appear after the previous one 
...
\frame[plain]{\titlepage
      \begin{tikzpicture}[remember picture,overlay]
            \node[xshift=-3cm,yshift=1.65cm] at (current page.south east) {\includegraphics[scale=.04]{logo_us_blanco.png}};
      \end{tikzpicture}
}
